...
//   const resizeTimerRef = useRef(null); // 🔧 useState 대신 useRef 사용
...
//     };
//   }, [stableOnRecalculateOverlays]); // 🔧 안정화된 함수만 의존성에 추가

//   // 🔧 리사이즈 감지 - resizeTimer 의존성 제거
//   useEffect(() => {
...
//       if (resizeTimerRef.current) clearTimeout(resizeTimerRef.current);
//     };
//   }, [overlaysCount, showOverlays, stableOnRecalculateOverlays]); // 🔧 resizeTimer 제거
...
//   // 🔧 오버레이 렌더링 로직을 별도 컴포넌트로 분리하거나 메모이제이션
