    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notice_type', models.CharField(choices=[('important', '중요'), ('update', '업데이트'), ('maintenance', '점검'), ('general', '일반')], default='general', max_length=20, verbose_name='공지 유형')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('online', '온라인'), ('busy', '진료중'), ('break', '휴식'), ('offline', '오프라인')], default='online', max_length=20, verbose_name='상태')),
