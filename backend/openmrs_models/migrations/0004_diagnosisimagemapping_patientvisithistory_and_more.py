# Generated by Django 4.2 on 2025-06-26 07:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['patient_uuid', 'encounter_uuid'], name='soap_diagno_patient_87eddb_idx'),
        ),
        migrations.AddIndex(
            model_name='soapdiagnosis',
            index=models.Index(fields=['icd10_code'], name='soap_diagno_icd10_c_164c00_idx'),
        ),
        migrations.AddIndex(
            model_name='soapdiagnosis',
            index=models.Index(fields=['soap_type', 'sequence_number'], name='soap_diagno_soap_ty_b39e57_idx'),
        ),
        migrations.AddField(
            model_name='diagnosisimagemapping',
            name='soap_diagnosis',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='image_mappings', to='openmrs_models.soapdiagnosis'),
        ),
