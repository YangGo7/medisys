class DatabaseRouter:
    ...
    def allow_migrate(self, db, app_label, model_name=None, **hints):
        ...
        if db == 'openmrs':
            ...
            return app_label in ['auth', 'contenttypes', 'sessions', 'admin', 'medical_integration', 'samples', 'tests', 'orders_emr', 'ocs' , 'lis_cdss','worklist','accounts','ai_analysis','common','dr_annotations','dr_reports']
        return False